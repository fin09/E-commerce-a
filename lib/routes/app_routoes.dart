...
import 'package:ecommerce/screens/order_complete/order_complete_page.dart';
import 'package:ecommerce/screens/order_list/order_list_page.dart';
import 'package:ecommerce/screens/payment/payment_details_page.dart';
import 'package:ecommerce/screens/sign_Up/register_page.dart';
import 'package:ecommerce/screens/sign_in/login_page.dart';
import 'package:ecommerce/screens/track_order/track_order_page.dart';
...
class AppRoutes {
  ...
  static Map<String, WidgetBuilder> get routes => {
    ...
    inputCard: (context) => const PaymentDetailsPage(),
  };
}
